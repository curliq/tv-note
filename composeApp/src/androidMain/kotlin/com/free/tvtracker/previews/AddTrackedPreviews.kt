...
fun AddTrackedShowGridPreview() {
    val shows = listOf(
        ...
        AddTrackedItemUiModel(2, "2", "game 2", "", true, AddTrackedItemUiModel.TrackAction.Watching, true, false),
        AddTrackedItemUiModel(
            3,
            "3",
            "game of thrones 3",
        ...
        AddTrackedItemUiModel(
            ...
            "",
            false,
            AddTrackedItemUiModel.TrackAction.Watching, true, false
        ),
        AddTrackedItemUiModel(5, "5", "game of  4", "", true, AddTrackedItemUiModel.TrackAction.Watching, true, false),
    )
    MaterialTheme {
        Scaffold { p ->
